...
export default function Login() {
  ...
  const handleLogin = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setErrorMsg(err instanceof Error ? err.message : 'Terjadi kesalahan tidak terduga saat login');
    } finally {
      setIsLoading(false);
    }
    ...
    return (
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          />
          <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Silahkan Login ke Akun Anda </h2>
        </div>
