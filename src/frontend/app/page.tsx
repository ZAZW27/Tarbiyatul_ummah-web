    ...
    return (
        <main className=" flex flex-col  gap-16  max-w-7xl mx-auto px-4 py-8 sm:px-6 bg-gray-100">
            ...
            <section id="hero" className="w-full">
                <div className="flex h-auto w-full items-center justify-center border-2 border-dashed border-gray-500">
            ...
            <section id="sasaran_pelayanan">
                <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
                    ...
                    <div className="hidden h-32 border-2 border-dashed border-gray-400">
                        <p className="text-black flex items-center justify-center">
                            placeholder sasaran pelayanan
                        </p>
                    </div>
                    ...
                    <div className="hidden h-32 border-2 border-dashed border-gray-400">
                        <p className="text-blackflex items-center justify-center">
                            placeholder sasaran pelayanan
                        </p>
                    </div>
                </div>
            ...
            <section id="fasilitas_pelayanan">
                <div className=" grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="h-48 border-2 border-dashed border-gray-400">
