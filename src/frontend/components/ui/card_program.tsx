...
export function ProgramCardPendidikan() {
    return (
        <section className="relative flex flex-col rounded-xl overflow-hidden shadow-2xl w-full min-h-[200px]  md:text-lg  px-4 py-4">
            <Image
                alt="Your Company"
            ...
            <div className="relative z-10 flex flex-col h-full ">
                ...
                <div className="mt-auto self-end text-white text-lg font-bold cursor-pointer">
                    {'>>'}
                </div>
            </div>
        </section>
    ...
    return (
        <section className="relative flex flex-col rounded-xl overflow-hidden shadow-2xl w-full min-h-[200px]  md:text-lg  px-4 py-4">
            ...
            <div className="relative z-10 flex flex-col h-full p-2">
                <div className="text-white">
                    <h1 className="tracking-wide">Keagamaan</h1>
                    <hr className="border-t-[2px] border-white w-full opacity-100" />
                </div>
