                          ...
                          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div className="mt-2">
                              <p className="text-sm text-gray-400">
                                Apakah anda yakin ingin menghapus produk 'nama_produk'? tindakan ini tidak akan bisa di balikkan. Pastikan anda
                                benar-benar yakin untuk menghapus produk ini. 
                              </p>
                            </div>
                          </div>
                        </div>
