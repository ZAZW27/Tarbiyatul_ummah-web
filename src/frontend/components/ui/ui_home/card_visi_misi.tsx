...
export default function VisiMisiCard() {
    return (
        <section className="flex flex-col  items-center bg-gray-100 rounded-2xl shadow-lg/40 overflow-hidden">
            <div className="flex w-full flex-col px-8 pt-5 pb-4 bg-green-600 rounded-t-2xl items-center justify-center ">
                <h1 className="text-white text-lg font-semibold mb-2 text-center">Visi & Misi</h1>
                <hr className=" border-t-[3px] border-white w-64 opacity-100" />
            </div>
