...
export default function footer () {
    ...
    <div className="mx-auto max-w-7xl p-8 grid grid-cols-1 gap-y-6 md:grid-cols-3 md:gap-x-12">
            ...
            <div className="mb-4 flex items-center space-x-4">
                <img src="/images/logo_lksa.png" alt="logo LKSA" className="h-12 w-auto shrink-0" />
                ...
                <span className="text-sm font-medium leading-tight text-white">Balikpapan</span>
                    ...
                    LKSA Tarbiyatul Ummah merupakan  panti asuhan yang merawat dan mendidik anak-anak yatim piatu. 
                    LKSA Tarbiyatul  Ummah menyediakan berbagai fasilitas dan program pembinaan yang bertujuan untuk  
                    mendukung perkembangan anak secara moral, spiritual, dan sosial.
                     Anak-anak tidak  hanya mendapatkan pendidikan formal, tetapi juga dibekali pendidikan akhlak dan  agama
                </p>    
          </div>
        ...
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-1 gap-8 md:gap-12 md:grid-cols-16">
              <div className="md:col-span-6">
                  <h2 className="mb-6 text-sm font-semibold   text-white">Hubungi Kami</h2>
                  <ul className="space-y-6 text-sm text-white">

                      <li className="flex items-center space-x-3">
                        <img src="/icons/instagram_icon.png" alt="" className="h-8 w-auto" />
                          <a href="https://flowbite.com/" className="hover:underline">tarbiyatul.ummah.bpn</a>
                      </li>

                        <li className="flex items-center space-x-3">
                        <img src="/icons/telephone_icon.png" alt="" className="h-8 w-auto" />
                          <a href="https://flowbite.com/" className="hover:underline">08214161683655 (Ketua LKSA)</a>
                      </li>

                        <li className="flex items-center space-x-3">
                        <img src="/icons/email_icon.png" alt="" className="h-8 w-auto" />
                          <a href="https://flowbite.com/" className="hover:underline">lksatarbiyatulummahbpn@gmail.com</a>
                      </li>
                      
                  
                  </ul>
              </div>
              <div className="md:col-span-10 flex flex-col border-b border-white pb-8 md:border-none md:pb-0">
                  <h2 className="mb-6 text-sm font-semibold text-heading ">Lokasi</h2>
                    <div className="flex flex-row items-start justify-between gap-4">
                     <p className="text-white text-sm font-light">Kalimantan Timur, Balikpapan Jl. Soekarno Hatta KM 8 RT 68, Kelurahan Batu Ampar Balikpapan Utara</p>
                    
                    <div className=" h-40 w-50 shrink-0 overflow-hidden rounded bg-gray-600">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d949.1900372718183!2d116.88607340924449!3d-1.2053802958906559!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df148b472e21d05%3A0x8a18b06ce845e750!2sPanti%20Asuhan%20Tarbiyatul%20Ummah!5e1!3m2!1sen!2sid!4v1785673550400!5m2!1sen!2sid" 
